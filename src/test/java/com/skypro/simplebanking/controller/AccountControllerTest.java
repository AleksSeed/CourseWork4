...
import com.skypro.simplebanking.controller.SupportData.TestData;
...
class AccountControllerTest {
    ...
    void getUserAccount() throws Exception {
        Account randomAccount = testdata.findRandomAccountButExclude();
        BankingUserDetails authUser = testdata.getAuthUser(randomAccount.getUser().getId());
    ...
    void getUserAccount_AuthUserAndAccountUserIdMismatch_AccountNotFound() throws Exception {
        Account account1 = testdata.findRandomAccountButExclude();
        Account account2 = testdata.findRandomAccountButExclude(account1);
        account1.setUser(account2.getUser());

        BankingUserDetails authUser = testdata.getAuthUser(account1.getUser().getId());
